...
# Описание
Коллекция тестов для проектов SAFNews и SAFNote на pytest и unittest соответственно.

## Тесты на pytest для проекта SAFNews
test_routes.py:
...
## Тесты на unittest для проекта SAFNote
test_routes.py:
...
```
## Для проверки необходимо выполнить 4 действия:
